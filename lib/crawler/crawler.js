...
function classifySector(capabilities=[], keywords=[]){

const text = [...capabilities,...keywords].join(" ").toLowerCase()

if(
text.match(/machining|fabrication|welding|manufacturing|engineering|steel|metal/)
) return "industrial"

if(
text.match(/construction|builder|concrete|civil|carpentry|plumbing|electrical/)
) return "construction"

if(
text.match(/software|cyber|it services|web development|cloud/)
) return "technology"

if(
text.match(/legal|accounting|consulting|financial/)
) return "professional_services"

if(
text.match(/freight|logistics|transport|shipping|warehouse/)
) return "logistics"
...
const sector = classifySector(uniqueCapabilities,uniqueKeywords)
...
(abn,abn_name,website,domain,keywords,capabilities,industry,sector,last_crawled)
