...
{results.capabilities.map((c:any,i:number)=>{
...
className="w-6 h-6 rounded border object-contain"
onError={(e)=>{
  (e.target as HTMLImageElement).style.display = "none"
}}
/>
) : (
<div className="w-6 h-6 bg-gray-200 flex items-center justify-center rounded text-xs">
{s.abn_name?.charAt(0)}
</div>
)}
...
{results.locations.map((l:any,i:number)=>{
